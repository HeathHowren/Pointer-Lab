...
// Generated from the fonts shipped with Dear ImGui using
// misc/fonts/binary_to_compressed_c.cpp (-base85).
//
// The fonts are embedded rather than loaded from resources/fonts/ next to the
// executable: a missing TTF used to leave the font pointers null and crash the
// first panel that pushed the monospace font. Embedding also makes the
// executable genuinely self-contained.
//
// Roboto-Medium.ttf and Cousine-Regular.ttf are Apache-2.0 licensed by Google.
// See THIRD_PARTY_NOTICES.md.
// File: imgui/misc/fonts/Cousine-Regular.ttf (43912 bytes)
// Exported using: binary_to_compressed_c -base85 Cousine-Regular.ttf CousineRegular
inline const char CousineRegular_compressed_data_base85[47040+1] =
...
// File: imgui/misc/fonts/Roboto-Medium.ttf (162588 bytes)
// Exported using: binary_to_compressed_c -base85 Roboto-Medium.ttf RobotoMedium
inline const char RobotoMedium_compressed_data_base85[144680+1] =
